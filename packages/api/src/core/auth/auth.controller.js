...
let AuthController = class AuthController {
    ...
    async login(req, dto) {
        const { user, organization, tokens } = await this.authService.login(req.user, dto.organizationId);
        return {
            user: {
                id: user.id,
                email: user.email,
    ...
    async switchOrganization(user, dto) {
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Switch to a different organization' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Organization switched' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, auth_dto_1.SwitchOrganizationDto]),
    __metadata("design:returntype", Promise)
