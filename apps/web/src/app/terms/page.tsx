    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-16 px-4">
        <div className="container mx-auto max-w-3xl prose prose-neutral dark:prose-invert">
          ...
          <p>
            By accessing or using the Vibrant Events platform, you agree to be bound by
            these Terms of Service. If you do not agree, please do not use our services.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            Vibrant Events provides a cloud-based event management platform including
            registration, ticketing, check-in, communications, and analytics tools for
            event organizers and their attendees.
          </p>
          ...
          <p>
            Subscription fees are billed annually in South African Rands (ZAR). All fees
            are non-refundable unless otherwise stated. We reserve the right to modify
          ...
          <p>
            ...
            intellectual property rights over your event content, attendee data, or
          ...
          <p>
            ...
            Planned maintenance windows will be communicated in advance. Enterprise
            customers with SLA agreements have guaranteed uptime commitments.
          </p>

          <h2>8. Limitation of Liability</h2>
          <p>
            Vibrant Events shall not be liable for any indirect, incidental, or
          ...
          <h2>9. Termination</h2>
          <p>
            Either party may terminate the agreement at any time. Upon termination, you
            may request an export of your data within 30 days. After this period, your
